...
export const Skills = () => {
  return (
    <Area title={"Skills"}>
      ...
      <div className="container childrenTitle">
        <div className="row">
          <div className="col-6">
            <div className="mx-5">
          ...
          <div className="col-6">
            <h2>Soft Skills</h2> {/* Corrección aquí */}
            <ul>
              <li>
                <b>Communication:</b>
              ...
              <li>
                <b>Teamwork:</b>
                <p>Experience in collaborating with cross-functional teams</p>
              </li>
              <li>
                <b>Problem Solving:</b>
              ...
              <li>
                <b> Adaptability:</b>
                <p>Quick to learn and adapt to new technologies</p>{" "}
              </li>
            </ul>
          </div>
        </div>
